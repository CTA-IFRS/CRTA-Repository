			...
			<div class="my-3">
                ...
                <div class="card curso p-4 mt-1 mb-4" style="border-left: 10px #d3ddea solid;">
                    ...
                    <span class="badge bg-blue position-absolute">curso</span>
                        ...
                        <div class="col-sm-3 col-12 d-flex"><img class="img-fluid m-auto" src="{{url('/imagens/icon_curso1.png')}}" alt=""></div>
                    </div>
                </div>
                <div class="card curso p-4 mt-1 mb-4" style="border-left: 10px #d3ddea solid;">
                    <div class="row">
                    <span class="badge bg-blue position-absolute">curso</span>
                        ...
                        <div class="col-sm-3 col-12 d-flex"><img class="img-fluid m-auto" src="{{url('/imagens/icon_curso2.png')}}" alt=""></div>
                    </div>
                </div>
