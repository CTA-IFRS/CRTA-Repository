	...
	<div class="row m-0">
		...
		<div id="conteudo" class="col-12 p-0">
			...
			<div class="my-3">
                ...
                <div class="row" id="listagem_aprender">
                <div class="card curso p-4 mt-1 mb-4" style="border-left: 10px #d3ddea solid;">
                    ...
                    <span class="badge bg-blue position-absolute">curso</span>
                        <div class="col-12 d-flex"><img class="img-fluid m-auto" src="{{url('/imagens/icon_curso1.png')}}" alt=""></div>
                ...
                <div class="card curso p-4 mt-1 mb-4" style="border-left: 10px #d3ddea solid;">
                    <div class="row">
                    <span class="badge bg-blue position-absolute">curso</span>
                    <div class="col-12 d-flex"><img class="img-fluid m-auto" src="{{url('/imagens/icon_curso2.png')}}" alt=""></div>
                        <div class="col-12 pr-0 pt-4">
                ...
                <div class="card publicacao p-4 mt-1 mb-4" style="border-left: 10px #e2d3ea solid;">
                    ...
                    <span class="badge bg-purple position-absolute">publicação</span>
                        <div class="col-sm-6 col-12 p-0 ml-auto mr-auto mt-4 pt-2"><img class="img-fluid col-12" src="{{url('/imagens/conexoes-assistivas.png')}}" alt="capa do livro"></div>
                        <div class="col-12 pr-0 pt-4">
                ...
                <div class="card publicacao p-4 mt-1 mb-4" style="border-left: 10px #e2d3ea solid;">
                    <div class="row">
                    <span class="badge bg-purple position-absolute">publicação</span>
                        <div class="col-sm-6 col-12 p-0 ml-auto mr-auto mt-4 pt-2"><img class="img-fluid col-12" src="{{url('/imagens/afirmar.png')}}" alt="capa do livro"></div>
                        <div class="col-12 pr-0 pt-4">
                ...
                <div class="card publicacao p-4 mt-1 mb-4" style="border-left: 10px #e2d3ea solid;">
                    <div class="row">
                    <span class="badge bg-purple position-absolute">publicação</span>
                        <div class="col-sm-6 col-12 p-0 ml-auto mr-auto mt-4 pt-2"><img class="img-fluid col-12" src="{{url('/imagens/reflexoes.png')}}" alt="capa do livro"></div>
                        <div class="col-12 pr-0 pt-4">
                ...
                <div class="card publicacao p-4 mt-1 mb-4" style="border-left: 10px #e2d3ea solid;">
                    <div class="row">
                    <span class="badge bg-purple position-absolute">publicação</span>
                        <div class="col-sm-6 col-12 p-0 ml-auto mr-auto mt-4 pt-2"><img class="img-fluid col-12" src="{{url('/imagens/manual.png')}}" alt="capa do livro"></div>
                        <div class="col-12 pr-0 pt-4">
                ...
                <div class="card publicacao p-4 mt-1 mb-4" style="border-left: 10px #e2d3ea solid;">
                    <div class="row">
                    <span class="badge bg-purple position-absolute">publicação</span>
                        <div class="col-sm-6 col-12 p-0 ml-auto mr-auto mt-4 pt-2"><img class="img-fluid col-12" src="{{url('/imagens/uso-pedagogico.png')}}" alt="capa do livro"></div>
                        <div class="col-12 pr-0 pt-4">
                ...
                <div class="card publicacao p-4 mt-1 mb-4" style="border-left: 10px #e2d3ea solid;">
                    <div class="row">
                    <span class="badge bg-purple position-absolute">publicação</span>
                        <div class="col-sm-6 col-12 p-0 ml-auto mr-auto mt-4 pt-2"><img class="img-fluid col-12" src="{{url('/imagens/solucoes.png')}}" alt="capa do livro"></div>
                        <div class="col-12 pr-0 pt-4">
                ...
                <div class="card publicacao p-4 mt-1 mb-4" style="border-left: 10px #e2d3ea solid;">
                    <div class="row">
                    <span class="badge bg-purple position-absolute">publicação</span>
                        <div class="col-sm-6 col-12 p-0 ml-auto mr-auto mt-4 pt-2"><img class="img-fluid col-12" src="{{url('/imagens/acessibilidade.png')}}" alt="capa do livro"></div>
                        <div class="col-12 pr-0 pt-4">
