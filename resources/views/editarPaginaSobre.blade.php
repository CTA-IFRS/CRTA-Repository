...
<h1 class="display-3">Edição da Página <i>Sobre</i></h1>
<p class="mt-3 ml-2">Edite o conteúdo a ser exibido na página "Sobre"</p>
@endsection

@section('content')
<div class="container">
	<form id="editarPaginaSobre" method="post" action="{{ route('salvarEdicaoPaginaSobre') }}">
		@csrf
  	...
  	<div class="modal-dialog">
    	<div class="modal-content">
    		...
    		<div class="modal-body">
       			<p>O conteúdo da página "Sobre" foi editado e publicado com sucesso!</p>
    		</div>
   			<!-- Modal footer -->
    		<div class="modal-footer">
				<a class="btn btn-primary" href="{{route('editarPaginaSobre')}}">Ok</a>
